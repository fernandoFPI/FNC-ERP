...
const MFG_TYPES = ['manufacturing_request', 'manufacturing_request_approved', 'manufacturing_request_rejected']
...
export default function NotificationsPage() {
  ...
  return (
    <div style={{ ...pagePadding, margin: '0 auto', maxWidth: '680px', paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 80px)' }}>
      <PageHeader
        title="Notifications"
      ...
      {/* Notification list */}
      <div style={{ background: theme.bgSurface, border: `1px solid ${theme.border}`, borderRadius: '12px', overflow: 'hidden' }}>
        {filtered.length === 0 ? (
