          ...
          <div style={{ padding: '24px' }}>
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="skeleton"
                style={{ height: '60px', borderRadius: '6px', marginBottom: '8px' }}
              />
            ))}
          </div>
        ) : configs.length ? (
                ...
                {configs.map((cfg) => {
                  ...
                  return (
                    <tr
                      ...
                      onMouseEnter={(e) => {
                        if (!isEditing) e.currentTarget.style.background = theme.tableRowHover
                      }}
                      onMouseLeave={(e) => {
                    ...
                    >
                      ...
                      {isEditing && editState ? (
                        <>
                          ...
                          <td style={{ padding: '6px 10px' }}>
                            <Input
                              ...
                              onChange={(e) => {
                                setEditState((s) =>
                                  s ? { ...s, initialRetryDelaySeconds: e.target.value } : s,
                                )
                              }}
                              type="number"
                              style={{ width: '80px' }}
                          ...
                          <td style={{ padding: '6px 10px' }}>
                            <Input
                              ...
                              onChange={(e) => {
                                setEditState((s) =>
                                  s ? { ...s, backoffMultiplier: e.target.value } : s,
                                )
                              }}
                              type="number"
                              step="0.1"
                          ...
                          <td style={{ padding: '6px 10px' }}>
                            <Input
                              ...
                              onChange={(e) => {
                                setEditState((s) =>
                                  s ? { ...s, maxRetryDelaySeconds: e.target.value } : s,
                                )
                              }}
                              type="number"
                              style={{ width: '80px' }}
                          ...
                          <td style={{ padding: '6px 10px' }}>
                            <input
                              ...
                              onChange={(e) => {
                                setEditState((s) =>
                                  s ? { ...s, alertOnDlq: e.target.checked } : s,
                                )
                              }}
                            />
                          </td>
                        ...
                        <>
                          ...
                          <td style={{ padding: '10px 14px', color: theme.textSecondary }}>
                            {cfg.initialRetryDelaySeconds}s
                          </td>
                          <td style={{ padding: '10px 14px', color: theme.textSecondary }}>
                            {cfg.backoffMultiplier}x
                          </td>
                          <td style={{ padding: '10px 14px', color: theme.textSecondary }}>
                            {cfg.maxRetryDelaySeconds}s
                          </td>
                          <td style={{ padding: '10px 14px' }}>
