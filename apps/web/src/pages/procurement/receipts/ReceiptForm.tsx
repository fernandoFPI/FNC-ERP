  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (photosFailed > 0) {
        addToast({
          type: 'error',
          message: `Receipt saved but ${photosFailed} photo${photosFailed > 1 ? 's' : ''} failed to upload. Fix the errors above and re-submit the failed photos.`,
        })
