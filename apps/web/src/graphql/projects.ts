...
export const UPDATE_LIFECYCLE_PHASE = gql`
  mutation UpdateLifecyclePhase($key: String!, $label: String, $sequence: Int, $optional: Boolean) {
    updateLifecyclePhase(key: $key, label: $label, sequence: $sequence, optional: $optional) {
      key
      label
      sequence
      optional
...
export const UPDATE_LIFECYCLE_MODULE = gql`
  mutation UpdateLifecycleModule($moduleKey: String!, $label: String, $minPhaseKey: String) {
    updateLifecycleModule(moduleKey: $moduleKey, label: $label, minPhaseKey: $minPhaseKey) {
      moduleKey
      minPhaseKey
      label
      sequence
...
export const HOLD_PROJECT = gql`
  mutation HoldProject($id: ID!, $reason: String!) {
    holdProject(id: $id, reason: $reason) {
      id
      status
      holdReason
      allowedActions
...
export const REJECT_BACK_PROJECT = gql`
  mutation RejectBackProject($id: ID!, $reason: String!) {
    rejectBackProject(id: $id, reason: $reason) {
      id
      status
      lifecyclePhase
      allowedActions
...
export const CANCEL_PROJECT = gql`
  mutation CancelProject($id: ID!, $reason: String!) {
    cancelProject(id: $id, reason: $reason) {
      id
      status
      cancelReason
      allowedActions
...
export const CANCEL_PROJECT_AFTER_APPROVAL = gql`
  mutation CancelProjectAfterApproval($id: ID!, $reason: String!) {
    cancelProjectAfterApproval(id: $id, reason: $reason) {
      id
      status
      cancelReason
      allowedActions
...
export const ADMIN_SET_PROJECT_STATUS = gql`
  mutation AdminSetProjectStatus($id: ID!, $status: String!) {
    adminSetProjectStatus(id: $id, status: $status) {
      id
      status
      lifecyclePhase
      allowedActions
...
export const ADMIN_SET_PHASE = gql`
  mutation AdminSetPhase($id: ID!, $phase: String!) {
    adminSetPhase(id: $id, phase: $phase) {
      id
      status
      lifecyclePhase
      allowedActions
...
export const ADVANCE_PHASE = gql`
  mutation AdvancePhase($id: ID!, $targetPhase: String!) {
    advancePhase(id: $id, targetPhase: $targetPhase) {
      id
      status
      lifecyclePhase
      allowedActions
...
export const VOID_PROJECT_INVOICE = gql`
  mutation VoidProjectInvoice($id: ID!, $reason: String) {
    voidProjectInvoice(id: $id, reason: $reason) {
      id
      status
    }
  }
...
export const REACH_MILESTONE = gql`
  mutation ReachMilestone($contractId: ID!, $milestoneId: ID!) {
    reachMilestone(contractId: $contractId, milestoneId: $milestoneId) {
      id
      status
      reachedAt
    }
...
export const UPDATE_CLIENT_DOCUMENT_STATUS = gql`
  mutation UpdateClientDocumentStatus($id: ID!, $status: String!) {
    updateClientDocumentStatus(id: $id, status: $status) {
      id
      status
    }
  }
...
export const ENG_DOCS_QUERY = gql`
  ...
  query EngineeringDocuments($projectId: ID!) {
    engineeringDocuments(projectId: $projectId) {
      ...EngDocFields
    }
  }
`
...
export const IFC_DOCS_QUERY = gql`
  ...
  query IFCDocuments($projectId: ID!, $status: [String]) {
    engineeringDocuments(projectId: $projectId, status: $status) {
      ...EngDocFields
    }
  }
`
...
export const UPDATE_ENG_DOC_STATUS = gql`
  mutation UpdateEngineeringDocStatus(
    $id: ID!
    $status: String!
    $purposeOfIssue: String
    $workflowNote: String
  ) {
    updateEngineeringDocStatus(
      id: $id
      status: $status
      purposeOfIssue: $purposeOfIssue
...
export const ENG_CLIENT_COMMENTS_QUERY = gql`
  ...
  query EngClientComments($documentId: ID!) {
    engClientComments(documentId: $documentId) {
      ...ClientCommentFields
    }
  }
`
...
export const UPDATE_ENG_CLIENT_COMMENT = gql`
  ${CLIENT_COMMENT_FIELDS}
  mutation UpdateEngClientComment(
    $id: ID!
    $description: String
    $clauseRef: String
    $category: String
...
export const CLOSE_ENG_CLIENT_COMMENT = gql`
  ...
  mutation CloseEngClientComment($id: ID!, $resolution: String!) {
    closeEngClientComment(id: $id, resolution: $resolution) {
      ...ClientCommentFields
    }
  }
`
...
export const DELETE_ENG_CLIENT_COMMENT = gql`
  mutation DeleteEngClientComment($id: ID!) {
    deleteEngClientComment(id: $id)
  }
`
...
export const DELETE_ENG_DOC = gql`
  mutation DeleteEngineeringDoc($id: ID!) {
    deleteEngineeringDoc(id: $id)
  }
`
...
export const DOC_COMMENTS_QUERY = gql`
  ...
  query DocComments($documentId: ID!) {
    docComments(documentId: $documentId) {
      ...DocCommentFields
    }
  }
`
...
export const RESPOND_TO_COMMENT = gql`
  ...
  mutation RespondToComment($id: ID!, $responseText: String!, $resolution: String!) {
    respondToComment(id: $id, responseText: $responseText, resolution: $resolution) {
      ...DocCommentFields
    }
  }
`
...
export const DOC_DISTRIBUTION_QUERY = gql`
  ...
  query DocDistributionMatrix($projectId: ID!) {
    docDistributionMatrix(projectId: $projectId) {
      ...DDMFields
    }
  }
`
...
export const DELETE_DISTRIBUTION_ENTRY = gql`
  mutation DeleteDistributionEntry($id: ID!) {
    deleteDistributionEntry(id: $id)
  }
`
...
export const BID_DELIVERABLES_QUERY = gql`
  ...
  query BidDeliverables($projectId: ID!) {
    bidDeliverables(projectId: $projectId) {
      ...BidDeliverableFields
    }
  }
`
...
export const DELETE_BID_DELIVERABLE = gql`
  mutation DeleteBidDeliverable($id: ID!) {
    deleteBidDeliverable(id: $id)
  }
`

export const UPLOAD_BID_DELIVERABLE_FILE = gql`
  ${BID_DELIVERABLE_FIELDS}
  mutation UploadBidDeliverableFile(
    $deliverableId: ID!
    $fileId: ID!
    $title: String
    $description: String
  ) {
    uploadBidDeliverableFile(
...
export const CREATE_BID_SUPPLIER_QUOTATION = gql`
  mutation CreateBidSupplierQuotation(
    $projectId: ID!
    $supplierName: String!
...
export const UPDATE_BID_SUPPLIER_QUOTATION = gql`
  mutation UpdateBidSupplierQuotation(
    $id: ID!
    $status: String
    $supplierName: String
    $itemDescription: String
...
export const DELETE_BID_SUPPLIER_QUOTATION = gql`
  mutation DeleteBidSupplierQuotation($id: ID!) {
    deleteBidSupplierQuotation(id: $id)
  }
`
...
export const BID_COMMERCIAL_SUMMARY_QUERY = gql`
  ...
  query BidCommercialSummary($projectId: ID!) {
    bidCommercialSummary(projectId: $projectId) {
      ...BidCommercialSummaryFields
    }
  }
`
...
export const UPDATE_BID_COMMERCIAL_SUMMARY = gql`
  ${BID_COMMERCIAL_SUMMARY_FIELDS}
  mutation UpdateBidCommercialSummary(
    $projectId: ID!
    $overheadPct: Float
    $marginPct: Float
    $discountPct: Float
...
export const SUBMIT_BID_FOR_APPROVAL = gql`
  ...
  mutation SubmitBidForApproval($projectId: ID!) {
    submitBidForApproval(projectId: $projectId) {
      ...BidCommercialSummaryFields
    }
  }
`
...
export const APPROVE_BID = gql`
  ...
  mutation ApproveBid($projectId: ID!) {
    approveBid(projectId: $projectId) {
      ...BidCommercialSummaryFields
    }
  }
`
...
export const REJECT_BID = gql`
  ...
  mutation RejectBid($projectId: ID!, $reason: String!) {
    rejectBid(projectId: $projectId, reason: $reason) {
      ...BidCommercialSummaryFields
    }
  }
`
...
export const REVISE_BID = gql`
  ...
  mutation ReviseBid($projectId: ID!, $changeSummary: String!) {
    reviseBid(projectId: $projectId, changeSummary: $changeSummary) {
      ...BidCommercialSummaryFields
    }
  }
`
...
export const PROJECT_RFIS_QUERY = gql`
  ${EXEC_FILE_FIELDS}
  ${RFI_FIELDS}
  query ProjectRFIs($projectId: ID!) {
    projectRFIs(projectId: $projectId) {
      ...RFIFields
    }
  }
`
...
export const RESPOND_TO_RFI = gql`
  ...
  mutation RespondToRFI($id: ID!, $response: String!, $respondedDate: String) {
    respondToRFI(id: $id, response: $response, respondedDate: $respondedDate) {
      ...RFIFields
    }
  }
`
export const DELETE_PROJECT_RFI = gql`
  mutation DeleteProjectRFI($id: ID!) {
    deleteProjectRFI(id: $id)
  }
`
export const UPLOAD_RFI_FILE = gql`
  ...
  mutation UploadRFIFile($rfiId: ID!, $fileId: ID!, $title: String) {
    uploadRFIFile(rfiId: $rfiId, fileId: $fileId, title: $title) {
      ...RFIFields
    }
  }
`
export const DELETE_RFI_FILE = gql`
  mutation DeleteRFIFile($attachmentId: ID!, $rfiId: ID!) {
    deleteRFIFile(attachmentId: $attachmentId, rfiId: $rfiId)
  }
`
...
export const PROJECT_SITE_INSTRUCTIONS_QUERY = gql`
  ${EXEC_FILE_FIELDS}
  ${SI_FIELDS}
  query ProjectSiteInstructions($projectId: ID!) {
    projectSiteInstructions(projectId: $projectId) {
      ...SIFields
    }
  }
`
export const CREATE_SITE_INSTRUCTION = gql`
  ${EXEC_FILE_FIELDS}
  ${SI_FIELDS}
  mutation CreateSiteInstruction(
    $projectId: ID!
    $siNumber: String!
    $subject: String!
    $description: String
...
export const UPDATE_SITE_INSTRUCTION = gql`
  ${EXEC_FILE_FIELDS}
  ${SI_FIELDS}
  mutation UpdateSiteInstruction(
    $id: ID!
    $subject: String
    $description: String
    $issuedBy: String
...
`
export const DELETE_SITE_INSTRUCTION = gql`
  mutation DeleteSiteInstruction($id: ID!) {
    deleteSiteInstruction(id: $id)
  }
`
export const UPLOAD_SI_FILE = gql`
  ...
  mutation UploadSIFile($siId: ID!, $fileId: ID!, $title: String) {
    uploadSIFile(siId: $siId, fileId: $fileId, title: $title) {
      ...SIFields
    }
  }
`
export const DELETE_SI_FILE = gql`
  mutation DeleteSIFile($attachmentId: ID!, $siId: ID!) {
    deleteSIFile(attachmentId: $attachmentId, siId: $siId)
  }
`
...
export const PROJECT_ITPS_QUERY = gql`
  ${ITP_FIELDS}
  query ProjectITPs($projectId: ID!) {
    projectITPs(projectId: $projectId) {
      ...ITPFields
    }
  }
`
...
`
export const DELETE_PROJECT_ITP = gql`
  mutation DeleteProjectITP($id: ID!) {
    deleteProjectITP(id: $id)
  }
`
export const UPSERT_ITP_ITEMS = gql`
  ${ITP_FIELDS}
  mutation UpsertITPItems($itpId: ID!, $items: [ITPItemInput!]!) {
    upsertITPItems(itpId: $itpId, items: $items) {
      ...ITPFields
    }
  }
`
export const RECORD_ITP_ITEM_RESULT = gql`
  mutation RecordITPItemResult(
    $itemId: ID!
    $result: String!
...
export const PROJECT_INSPECTION_REQUESTS_QUERY = gql`
  ${EXEC_FILE_FIELDS}
  ${IR_FIELDS}
  query ProjectInspectionRequests($projectId: ID!) {
    projectInspectionRequests(projectId: $projectId) {
      ...IRFields
    }
  }
`
export const CREATE_INSPECTION_REQUEST = gql`
  ${EXEC_FILE_FIELDS}
  ${IR_FIELDS}
  mutation CreateInspectionRequest(
    $projectId: ID!
    $irNumber: String!
    $title: String!
    $itpId: ID
...
export const UPDATE_INSPECTION_REQUEST = gql`
  ${EXEC_FILE_FIELDS}
  ${IR_FIELDS}
  mutation UpdateInspectionRequest(
    $id: ID!
    $title: String
    $location: String
    $requestedDate: String
...
`
export const DELETE_INSPECTION_REQUEST = gql`
  mutation DeleteInspectionRequest($id: ID!) {
    deleteInspectionRequest(id: $id)
  }
`
export const UPLOAD_IR_FILE = gql`
  ...
  mutation UploadIRFile($irId: ID!, $fileId: ID!, $title: String) {
    uploadIRFile(irId: $irId, fileId: $fileId, title: $title) {
      ...IRFields
    }
  }
`
export const DELETE_IR_FILE = gql`
  mutation DeleteIRFile($attachmentId: ID!, $irId: ID!) {
    deleteIRFile(attachmentId: $attachmentId, irId: $irId)
  }
`
...
export const PROJECT_NCRS_QUERY = gql`
  ${EXEC_FILE_FIELDS}
  ${NCR_FIELDS}
  query ProjectNCRs($projectId: ID!) {
    projectNCRs(projectId: $projectId) {
      ...NCRFields
    }
  }
`
...
`
export const DELETE_PROJECT_NCR = gql`
  mutation DeleteProjectNCR($id: ID!) {
    deleteProjectNCR(id: $id)
  }
`
export const UPLOAD_NCR_FILE = gql`
  ...
  mutation UploadNCRFile($ncrId: ID!, $fileId: ID!, $title: String) {
    uploadNCRFile(ncrId: $ncrId, fileId: $fileId, title: $title) {
      ...NCRFields
    }
  }
`
export const DELETE_NCR_FILE = gql`
  mutation DeleteNCRFile($attachmentId: ID!, $ncrId: ID!) {
    deleteNCRFile(attachmentId: $attachmentId, ncrId: $ncrId)
  }
`
...
export const PROJECT_HSE_RECORDS_QUERY = gql`
  ${EXEC_FILE_FIELDS}
  ${HSE_FIELDS}
  query ProjectHSERecords($projectId: ID!, $recordType: String) {
    projectHSERecords(projectId: $projectId, recordType: $recordType) {
      ...HSEFields
    }
  }
`
...
export const UPDATE_HSE_RECORD = gql`
  ...
  mutation UpdateHSERecord(
    ...
    updateHSERecord(
      ...
      rootCause: $rootCause
      correctiveAction: $correctiveAction
      correctiveDueDate: $correctiveDueDate
      correctiveClosedDate: $correctiveClosedDate
      observationType: $observationType
      ptwType: $ptwType
      ptwNumber: $ptwNumber
      validFrom: $validFrom
...
`
export const DELETE_HSE_RECORD = gql`
  mutation DeleteHSERecord($id: ID!) {
    deleteHSERecord(id: $id)
  }
`
export const UPLOAD_HSE_FILE = gql`
  ...
  mutation UploadHSEFile($hseId: ID!, $fileId: ID!, $title: String) {
    uploadHSEFile(hseId: $hseId, fileId: $fileId, title: $title) {
      ...HSEFields
    }
  }
`
...
const BASELINE_FIELDS = gql`
  fragment BaselineFields on ProjectBaseline {
    id
    projectId
    name
    description
...
const RESOURCE_FIELDS = gql`
  fragment ResourceFields on ProjectResource {
    id
    projectId
    name
    resourceType
...
export const PROJECT_BASELINES_QUERY = gql`
  ${BASELINE_FIELDS}
  query ProjectBaselines($projectId: ID!) {
    projectBaselines(projectId: $projectId) {
      ...BaselineFields
    }
  }
`
...
export const PROJECT_RESOURCES_QUERY = gql`
  ${RESOURCE_FIELDS}
  query ProjectResources($projectId: ID!) {
...
export const PROJECT_RESOURCE_CALENDAR_QUERY = gql`
  query ProjectResourceCalendar($resourceId: ID!) {
    projectResourceCalendar(resourceId: $resourceId) {
      id
      resourceId
      workDate
      availableUnits
...
export const UPDATE_ACTIVITY_PROGRESS = gql`
  ${ACTIVITY_FIELDS}
  mutation UpdateActivityProgress(
    $id: ID!
...
export const BULK_IMPORT_ACTIVITIES = gql`
  mutation BulkImportActivities(
    $projectId: ID!
    $activities: [ActivityImportInput!]!
    $dependencies: [DependencyImportInput!]
...
`
export const RECALCULATE_CPM = gql`
  mutation RecalculateCPM($projectId: ID!) {
    recalculateCPM(projectId: $projectId)
  }
`
export const LEVEL_RESOURCES = gql`
  mutation LevelResources($projectId: ID!) {
    levelResources(projectId: $projectId)
  }
`
...
export const CREATE_BASELINE = gql`
  ...
  mutation CreateBaseline($projectId: ID!, $name: String!, $description: String) {
    createBaseline(projectId: $projectId, name: $name, description: $description) {
      ...BaselineFields
    }
  }
`
export const SET_ACTIVE_BASELINE = gql`
  ${BASELINE_FIELDS}
  mutation SetActiveBaseline($id: ID!) {
    setActiveBaseline(id: $id) {
      ...BaselineFields
    }
  }
`
export const APPLY_BASELINE = gql`
  mutation ApplyBaseline($id: ID!) {
    applyBaseline(id: $id)
  }
`
export const DELETE_BASELINE = gql`
  mutation DeleteBaseline($id: ID!) {
...
export const DELETE_CALENDAR_DAY = gql`
  mutation DeleteCalendarDay($id: ID!) {
    deleteCalendarDay(id: $id)
  }
`
...
`
export const REMOVE_RESOURCE_ASSIGNMENT = gql`
  mutation RemoveResourceAssignment($id: ID!) {
    removeResourceAssignment(id: $id)
  }
`
...
export const PROJECT_COST_CODES_QUERY = gql`
  ${COST_CODE_FIELDS}
  query ProjectCostCodes($projectId: ID!) {
    projectCostCodes(projectId: $projectId) {
      ...CostCodeFields
    }
  }
`
export const PROJECT_COMMITTED_COSTS_QUERY = gql`
  ${COMMITTED_FIELDS}
  query ProjectCommittedCosts($projectId: ID!) {
    projectCommittedCosts(projectId: $projectId) {
      ...CommittedFields
    }
  }
`
export const PROJECT_CASH_FLOW_QUERY = gql`
  ${CASH_FLOW_FIELDS}
  query ProjectCashFlow($projectId: ID!) {
...
export const PROJECT_SUBCONTRACTS_QUERY = gql`
  ${SUBCONTRACT_FIELDS}
  query ProjectSubcontracts($projectId: ID!) {
    projectSubcontracts(projectId: $projectId) {
      ...SubcontractFields
    }
  }
`
export const PROJECT_LABOR_ENTRIES_QUERY = gql`
  ...
  query ProjectLaborEntries($projectId: ID!, $startDate: String, $endDate: String) {
    projectLaborEntries(projectId: $projectId, startDate: $startDate, endDate: $endDate) {
      ...LaborFields
    }
  }
`
export const PROJECT_EQUIPMENT_LOG_QUERY = gql`
  ...
  query ProjectEquipmentLog($projectId: ID!, $startDate: String, $endDate: String) {
    projectEquipmentLog(projectId: $projectId, startDate: $startDate, endDate: $endDate) {
      ...EquipmentFields
    }
  }
`
export const PROJECT_COST_FORECAST_QUERY = gql`
  query ProjectCostForecast($projectId: ID!) {
    projectCostForecast(projectId: $projectId) {
      id
      projectId
      costCodeId
      costCodeName
...
export const PROJECT_CLIENT_BILLINGS_QUERY = gql`
  ...
  query ProjectClientBillings($projectId: ID!) {
    projectClientBillings(projectId: $projectId) {
      ...ClientBillingFields
    }
  }
`
...
export const DELETE_COST_CODE = gql`
  mutation DeleteCostCode($id: ID!) {
    deleteCostCode(id: $id)
  }
`

// Committed cost mutations
export const CREATE_COMMITTED_COST = gql`
  ${COMMITTED_FIELDS}
  mutation CreateCommittedCost(
    $projectId: ID!
    $costCodeId: ID
...
`
export const UPDATE_COMMITTED_COST = gql`
  ${COMMITTED_FIELDS}
  mutation UpdateCommittedCost(
    $id: ID!
    $costCodeId: ID
    $description: String
    $vendorName: String
...
`
export const DELETE_COMMITTED_COST = gql`
  mutation DeleteCommittedCost($id: ID!) {
    deleteCommittedCost(id: $id)
  }
`
export const SYNC_PO_COMMITMENTS = gql`
  mutation SyncPOCommitments($projectId: ID!) {
    syncPOCommitments(projectId: $projectId)
  }
`

// Cash flow
export const UPSERT_CASH_FLOW_PERIOD = gql`
  ${CASH_FLOW_FIELDS}
  mutation UpsertCashFlowPeriod(
    $projectId: ID!
    $periodYear: Int!
    $periodMonth: Int!
...
export const DELETE_SUBCONTRACT = gql`
  mutation DeleteSubcontract($id: ID!) {
    deleteSubcontract(id: $id)
  }
`
export const CREATE_SUBCONTRACT_BILLING = gql`
  mutation CreateSubcontractBilling(
    $subcontractId: ID!
...
`
export const UPDATE_SUBCONTRACT_BILLING = gql`
  mutation UpdateSubcontractBilling(
    $id: ID!
    $certifiedAmount: Float
...
`
export const DELETE_SUBCONTRACT_BILLING = gql`
  mutation DeleteSubcontractBilling($id: ID!) {
    deleteSubcontractBilling(id: $id)
  }
`

// Labor mutations
export const CREATE_LABOR_ENTRY = gql`
  ${LABOR_FIELDS}
  mutation CreateLaborEntry(
    $projectId: ID!
    $costCodeId: ID
    $activityId: ID
    $workDate: String!
...
`
export const UPDATE_LABOR_ENTRY = gql`
  ${LABOR_FIELDS}
  mutation UpdateLaborEntry(
    $id: ID!
    $trade: String
    $workerName: String
    $regularHours: Float
...
`
export const DELETE_LABOR_ENTRY = gql`
  mutation DeleteLaborEntry($id: ID!) {
    deleteLaborEntry(id: $id)
  }
`

// Equipment mutations
export const CREATE_EQUIPMENT_LOG = gql`
  ${EQUIPMENT_FIELDS}
  mutation CreateEquipmentLog(
    $projectId: ID!
    $costCodeId: ID
    $logDate: String!
...
`
export const UPDATE_EQUIPMENT_LOG = gql`
  ${EQUIPMENT_FIELDS}
...
`
export const DELETE_EQUIPMENT_LOG = gql`
  mutation DeleteEquipmentLog($id: ID!) {
    deleteEquipmentLog(id: $id)
  }
`

// Forecast
export const UPSERT_COST_FORECAST = gql`
  mutation UpsertCostForecast(
    $projectId: ID!
    $costCodeId: ID
    $forecastDate: String!
    $etcAmount: Float!
...
`
export const DELETE_CLIENT_BILLING = gql`
  mutation DeleteClientBilling($id: ID!) {
    deleteClientBilling(id: $id)
  }
`
...
export const PROJECT_VARIATION_ORDERS_QUERY = gql`
  ...
  query ProjectVariationOrders($projectId: ID!) {
    projectVariationOrders(projectId: $projectId) {
      ...VOFields
    }
  }
`
...
export const PROJECT_VARIATION_ORDER_QUERY = gql`
  ...
  query ProjectVariationOrder($id: ID!) {
    projectVariationOrder(id: $id) {
      ...VOFields
    }
  }
`

export const CREATE_VARIATION_ORDER = gql`
  ${VO_FIELDS}
  mutation CreateVariationOrder(
    $projectId: ID!
    $voNumber: String!
    $title: String!
    $description: String
...
`
export const UPDATE_VARIATION_ORDER = gql`
  ${VO_FIELDS}
  mutation UpdateVariationOrder(
    $id: ID!
    $title: String
    $description: String
    $changeType: String
...
`
export const DELETE_VARIATION_ORDER = gql`
  mutation DeleteVariationOrder($id: ID!) {
    deleteVariationOrder(id: $id)
  }
`
export const SUBMIT_VARIATION_ORDER = gql`
  ${VO_FIELDS}
  mutation SubmitVariationOrder($id: ID!) {
    submitVariationOrder(id: $id) {
      ...VOFields
    }
  }
`
export const APPROVE_VARIATION_ORDER = gql`
  ${VO_FIELDS}
  mutation ApproveVariationOrder($id: ID!, $approvedValue: Float!, $contractId: ID) {
    approveVariationOrder(id: $id, approvedValue: $approvedValue, contractId: $contractId) {
      ...VOFields
    }
  }
`
export const REJECT_VARIATION_ORDER = gql`
  ${VO_FIELDS}
  mutation RejectVariationOrder($id: ID!, $reason: String!) {
    rejectVariationOrder(id: $id, reason: $reason) {
      ...VOFields
    }
  }
`
export const SET_VO_STATUS = gql`
  ${VO_FIELDS}
  mutation SetVOStatus($id: ID!, $status: String!) {
    setVOStatus(id: $id, status: $status) {
      ...VOFields
    }
  }
`

export const CREATE_VO_COST_ITEM = gql`
  mutation CreateVOCostItem(
    $voId: ID!
    $category: String!
    $description: String!
    $quantity: Float
...
`
export const UPDATE_VO_COST_ITEM = gql`
  mutation UpdateVOCostItem(
    $id: ID!
    $category: String
    $description: String
    $quantity: Float
...
`
export const DELETE_VO_COST_ITEM = gql`
  mutation DeleteVOCostItem($id: ID!) {
    deleteVOCostItem(id: $id)
  }
`

export const CREATE_VO_CORRESPONDENCE = gql`
  mutation CreateVOCorrespondence(
    $voId: ID!
...
`
export const DELETE_VO_CORRESPONDENCE = gql`
  mutation DeleteVOCorrespondence($id: ID!) {
    deleteVOCorrespondence(id: $id)
  }
`

export const ADD_VO_DRAWING = gql`
  mutation AddVODrawing(
    $voId: ID!
    $drawingNumber: String!
    $revision: String
    $title: String
...
`
export const REMOVE_VO_DRAWING = gql`
  mutation RemoveVODrawing($id: ID!) {
    removeVODrawing(id: $id)
  }
`
...
export const DELETE_PUNCH_ITEM = gql`
  mutation DeletePunchItem($id: ID!) {
    deletePunchItem(id: $id)
  }
`
...
export const DELETE_PUNCH_PHOTO = gql`
  mutation DeletePunchPhoto($id: ID!) {
    deletePunchPhoto(id: $id)
  }
`
...
export const DELETE_HANDOVER_ITEM = gql`
  mutation DeleteHandoverItem($id: ID!) {
    deleteHandoverItem(id: $id)
  }
`
