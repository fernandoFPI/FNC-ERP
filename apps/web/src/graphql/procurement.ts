...
export const PURCHASE_ORDERS_QUERY = gql`
  query PurchaseOrders($status: String, $vendorId: ID, $projectId: ID, $productId: ID, $myPOsOnly: Boolean) {
    purchaseOrders(status: $status, vendor_id: $vendorId, project_id: $projectId, product_id: $productId, myPOsOnly: $myPOsOnly) {
      id
      po_number
      vendor_name
      vendor_id
...
export const SUBMIT_PO_TO_INVENTORY = gql`
  mutation SubmitPOToInventoryCheck($id: ID!, $notes: String) {
    submitPOToInventoryCheck(id: $id, notes: $notes) {
      id
      status
    }
  }
...
export const CONFIRM_PO_INVENTORY = gql`
  mutation ConfirmPOInventoryCheck(
    $id: ID!
    $lineStockQtys: [StockConfirmLineInput!]!
    $notes: String
  ) {
    confirmPOInventoryCheck(id: $id, lineStockQtys: $lineStockQtys, notes: $notes) {
      id
      status
    }
  }
...
export const APPROVE_STOCK_ISSUANCE = gql`
  mutation ApproveStockIssuance($id: ID!, $notes: String) {
    approveStockIssuance(id: $id, notes: $notes) {
      id
      status
    }
  }
...
export const SUBMIT_PO_STORE_PRICING = gql`
  mutation SubmitPOStorePricing($id: ID!, $linePrices: [LinePriceInput!]) {
    submitPOStorePricing(id: $id, linePrices: $linePrices) {
      id
      status
    }
  }
...
export const SUBMIT_PO_MARKET_PRICING = gql`
  mutation SubmitPOMarketPricing($id: ID!, $vendorId: ID, $linePrices: [MarketPriceInput!]) {
    submitPOMarketPricing(id: $id, vendorId: $vendorId, linePrices: $linePrices) {
      id
      status
    }
  }
...
export const SUBMIT_PO_PRICE_VERIFICATION = gql`
  mutation SubmitPOPriceVerification(
    $id: ID!
    $verificationNotes: String
    $lineAdjustments: [PriceAdjustmentInput]
  ) {
    submitPOPriceVerification(
      id: $id
...
export const SET_PO_LINE_AUDIT_STATUS = gql`
  mutation SetPOLineAuditStatus(
    $poId: ID!
    $lineId: ID!
    $auditStatus: String!
    $auditNote: String
  ) {
    setPOLineAuditStatus(
      poId: $poId
      lineId: $lineId
...
export const COMPLETE_PO = gql`
  mutation CompletePO($id: ID!, $receiptNotes: String) {
    completePO(id: $id, receiptNotes: $receiptNotes) {
      id
      status
    }
  }
...
export const ADMIN_SET_PO_STATUS = gql`
  mutation AdminSetPOStatus($id: ID!, $status: String!) {
    adminSetPOStatus(id: $id, status: $status) {
      id
      status
    }
  }
...
export const SET_PO_PRIORITY = gql`
  mutation SetPOPriority($id: ID!, $priority: String!) {
    setPOPriority(id: $id, priority: $priority) {
      id
      priority
    }
  }
...
export const SET_PO_RECEIVER = gql`
  mutation SetPOReceiver($id: ID!, $employeeId: ID) {
    setPOReceiver(id: $id, employeeId: $employeeId) {
      id
      assigned_receiver_id
      assigned_receiver_name
    }
