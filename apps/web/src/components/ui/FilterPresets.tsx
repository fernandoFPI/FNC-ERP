        ...
        <div style={{
          ...
          {presets.length > 0 ? (
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      fontSize: '13px', color: theme.textPrimary, fontFamily: 'inherit',
                    }}
                    onMouseEnter={(e) => {
            ...
            <div style={{
              ...
              color: theme.textMuted, textAlign: 'center', fontStyle: 'italic',
            }}>
              No saved presets
            </div>
          )}
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '6px' }}>
              <input
                ...
                maxLength={50}
                style={{
                  flex: 1, padding: '6px 8px', borderRadius: '7px', fontSize: '12px',
