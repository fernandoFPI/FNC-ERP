    ...
    children: [
      ...
      // Projects
      {
        ...
        children: [
          ...
          { path: 'contracts', element: withPerm('projects.contracts.view', <ContractsPage />) },
          {
            path: 'contracts/new',
            element: withPerm('projects.contracts.edit', <ContractForm />, 'edit'),
          },
          { path: 'contracts/:id', element: withPerm('projects.contracts.view', <ContractDetail />) },
          {
